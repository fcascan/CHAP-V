...
try:
    from .coco_utils import COCO_test_helper, coco_eval_with_json
except ImportError:
    # Allow running this script directly from src/inference
    from coco_utils import COCO_test_helper, coco_eval_with_json
...
def setup_model(args):
    ...
    if model_path.endswith('.pt') or model_path.endswith('.torchscript'):
        ...
        platform = 'onnx'
        try:
            from .onnx_executor import ONNX_model_container_py as ONNX_model_container
        except ImportError:
            from onnx_executor import ONNX_model_container_py as ONNX_model_container
